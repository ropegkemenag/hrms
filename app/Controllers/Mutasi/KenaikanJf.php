...
namespace App\Controllers\Mutasi;
...
class Kenaikanjf extends BaseController
{
    ...
    public function detail($id,$step=false)
    {
      ...
      if($data['usul']->status_usulan == 1 || $data['usul']->status_usulan == 4){
        ...
        if($step == 1){
          return view('mutasi/kenaikanjf/detail_1', $data);
        }else if($step == 2){
          return view('mutasi/kenaikanjf/detail_2', $data);
        }else if($step == 3){
          return view('mutasi/kenaikanjf/detail_3', $data);
        }else{
          return view('mutasi/kenaikanjf/detail_1', $data);
        }
      }else{
        return view('mutasi/kenaikanjf/preview', $data);
        // print_r($data['usul']);
        // echo decrypt($id);
      }
    ...
    public function detailx($id)
    {
      ...
      if($data['usul']->status_usulan == 1 || $data['usul']->status_usulan == 4){
        return view('mutasi/kenaikanjf/detail', $data);
      }else{
        return view('mutasi/kenaikanjf/preview', $data);
      }
