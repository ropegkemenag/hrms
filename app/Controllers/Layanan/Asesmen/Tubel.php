...
namespace App\Controllers\Layanan\Asesmen;
...
class Tubel extends BaseController
{
    public function index()
    {
        ...
        return view('asesmen/tubel/index', $data);
    }
    ...
    public function detail($id,$step=false)
    {
      ...
      if($data['usul']->status_usulan == 1 || $data['usul']->status_usulan == 4){
        ...
        if($step == 1){
          return view('asesmen/tubel/detail_1', $data);
        }else if($step == 2){
          return view('asesmen/tubel/detail_2', $data);
        }else if($step == 3){
          return view('asesmen/tubel/detail_3', $data);
        }else{
          return view('asesmen/tubel/detail_1', $data);
        }
      }else{
        return view('asesmen/tubel/preview', $data);
      }
    ...
    public function addusul()
    {
      ...
      return redirect()->to('asesmen/tubel');
    }
