  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="d-flex align-items-start gap-3 mt-4 mb-4">
        <a href="<?= site_url('asesmen/tubel/detail/'.encrypt($usul->id).'/2')?>" class="btn btn-success btn-label left nexttab nexttab"><i class="ri-arrow-left-line label-icon align-middle fs-16 ms-2"></i>Lengkapi Dokumen (Step 2)</a>
        </div>
        ...
        <div class="col-md-8 col-lg-6 col-xl-8">
            <div class="card mt-4">
                <div class="card-body p-4">
                  ...
                  <a href="<?= site_url('asesmen/tubel/submit/'.encrypt($usul->id))?>" class="btn btn-success" onclick="return confirm('Apakah Anda yakin semua sudah sesuai?')">Kirim Usulan</a>
                </div>
            </div>
        </div>
      </div>
