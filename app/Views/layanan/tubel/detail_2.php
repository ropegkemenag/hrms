      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-12">
          <div class="page-header-title">
            <h2 class="mb-0">Usulan Tugas Belajar - Dokumen</h2>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="d-flex align-items-start gap-3 mt-4 mb-4">
        <a href="<?= site_url('asesmen/tubel/detail/'.encrypt($usul->id).'/1')?>" class="btn btn-success btn-label left nexttab nexttab"><i class="ri-arrow-left-line label-icon align-middle fs-16 ms-2"></i>Formulir Tubel (Step 1)</a>
        <?php if($docempty == 0){ ?>
          <a href="<?= site_url('asesmen/tubel/detail/'.encrypt($usul->id).'/3')?>" class="btn btn-success btn-label right ms-auto nexttab nexttab"><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Kirim Usulan (Step 3)</a>
        <?php }else{ ?>
          <button type="button" class="btn btn-label right ms-auto nexttab nexttab" name="button" disabled><i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Kirim Usulan (Step 3)</button>
        <?php } ?>
      </div>
    </div>
  </div>
