...
<head>
  <title>Verifikasi Data SIMPEG | Kementerian Agama RI</title>
  <!-- [Meta] -->
  <meta charset="utf-8" />
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="<?= site_url('simpeg/unor')?>" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item">
          <a href="<?= site_url('simpeg/mutasi')?>" class="pc-link">
            <span class="pc-micon">
              <i class="ph-duotone ph-database"></i>
            </span>
            <span class="pc-mtext">Mutasi Pegawai - Keluar</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="<?= site_url('simpeg/mutasi/inbox')?>" class="pc-link">
            <span class="pc-micon">
              <i class="ph-duotone ph-database"></i>
            </span>
            <span class="pc-mtext">Mutasi Pegawai - Masuk</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="<?= site_url('simpeg/pegawaibaru')?>" class="pc-link">
            ...
            <span class="pc-mtext">Pegawai Baru</span>
          </a>
        </li>
      </ul>
