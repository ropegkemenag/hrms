...
<head>
  <title>KGB Online | Kementerian Agama RI</title>
  <!-- [Meta] -->
  <meta charset="utf-8" />
  ...
  <div class="navbar-wrapper">
    ...
    <div class="navbar-content">
      <ul class="pc-navbar">
        ...
        <li class="pc-item">
          <a href="<?= site_url('kgb/setup')?>" class="pc-link">
            <span class="pc-micon">
        ...
        <li class="pc-item">
          <a href="<?= site_url('kgb/pegawai')?>" class="pc-link">
            <span class="pc-micon">
              <i class="ph-duotone ph-database"></i>
            </span>
            <span class="pc-mtext">Daftar Pegawai</span>
          </a>
        </li>
        <li class="pc-item">
          <a href="<?= site_url('kgb/proses')?>" class="pc-link">
            <span class="pc-micon">
              <i class="ph-duotone ph-database"></i>
            </span>
            <span class="pc-mtext">Proses KGB</span>
          </a>
        </li>
      </ul>
...
<div class="me-auto pc-mob-drp">
  <ul class="list-unstyled">
    ...
    <li class="pc-h-item">
      <strong>KENAIKAN GAJI BERKALA</strong>
    </li>
