        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-header small">
              <span class="menu-header-text" data-i18n="Kepegawaian">Verifikasi</span>
            </li>
            <!-- Cards -->
            <li class="menu-item">
              <a href="<?= site_url('verifikasi/inbox')?>" class="menu-link">
                ...
                <div data-i18n="Data Pegawai"> Inbox Usulan</div>
              </a>
            </li>

            <li class="menu-item">
              <a href="<?= site_url('verifikasi/riwayat')?>" class="menu-link">
                ...
                <div data-i18n="Download Data"> Riwayat Usulan</div>
              </a>
            </li>
            <li class="menu-header small">
