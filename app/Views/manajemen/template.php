        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= site_url('manajemen')?>" class="app-brand-link">
              <img src="<?= base_url()?>assets/img/hrms.png" width="50%" alt="">
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Misc -->
            <li class="menu-header small">
              <span class="menu-header-text" data-i18n="Layanan Kepegawaian">Adminstrasi</span>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('manajemen/access')?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-lifebuoy"></i>
                <div data-i18n="Pemutakhiran Data">Akses Pengguna</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('manajemen/setting/user')?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-file-description"></i>
                <div data-i18n="Pengguna">Reset Password</div>
              </a>
            </li>
            <li class="menu-header small">
            ...
            <li class="menu-item">
              <a href="<?= site_url()?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-chevron-left"></i>
