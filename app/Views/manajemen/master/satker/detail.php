          ...
          <tbody>
            <?php foreach ($satker as $row) {?>
              <tr>
                ...
                <td><?= $row->PROGRAM?></td>
                <td><a href="<?= site_url('master/satker/detail/'.encrypt($row->KODE_SATUAN_KERJA))?>"> <i class="ri-search-eye-line"></i> </a></td>
              </tr>
            <?php } ?>
          </tbody>
        </table>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="" action="<?= site_url('master/satker/update/'.encrypt($detail->KODE_SATUAN_KERJA))?>" method="post" id="addform" enctype="multipart/form-data">
                <div class="row mb-4">
                ...
                <div class="row mb-4">
                  <label for="perihal" class="col-sm-3 col-form-label">KODE UNOR BKN</label>
                  <div class="col-sm-9">
                    <input type="text" name="perihal" class="form-control" id="unor" required>
                  </div>
                </div>
                <div class="row mb-4">
                  <label for="perihal" class="col-sm-3 col-form-label">KOORDINAT</label>
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-4">
                    ...
                    <span class="text-primary">Lon</span>
                  </div>
                </div>
                <!-- <div class="row mb-4">
...
<script type="text/javascript">
  ...
  function edit(id) {
    alert('Loading...');
    axios.get('<?= site_url()?>/master/satker/getdata/'+id).then(function (response) {
